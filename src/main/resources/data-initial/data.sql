...
VALUES (1, '2022-08-19', 'Peaksoft', '4 спальни, 5 кроватей, 4 ванные', 2500, 10, 'HOUSE', 1, 1, 4),
       (2, '2022-04-10', 'Уютная квартира в Тунгуче', '3-комнат, 8-этаж', 1500, 3, 'APARTMENT', 1, 2, 5),
       (3, '2022-07-27', 'Элитка в микрашах', '1 спальня, 1 кровать, 1 ванная', 3500, 4, 'APARTMENT', 1, 3, 4),
       (4, '2022-08-04', 'Маяк', '4 спальни, 5 кроватей, 4 ванные', 1700, 8, 'HOUSE', 1, 4, 5),
       (5, '2022-08-05', 'Гостевой дом Парус', '2 спальни, 5 кроватей, 2 ванные', 1700, 5, 'HOUSE', 1, 5, 5),
       (6, '2022-08-06', 'Гостиница Алай', '6 спальни, 12 кроватей, 6 ванные', 1700, 18, 'HOUSE', 1, 6, 4),
       (7, '2022-08-06', 'Квартира для студентов', '2 спальни, 4 кроватей, газ, центр', 1700, 5, 'APARTMENT', 1, 7, 5),
       (8, '2022-08-07', 'Квартира для семьи', '1 спальни, газ, лифт', 800, 4, 'APARTMENT', 1, 8, 4),
       (9, '2022-08-07', 'Гостевой дом Айгул', '3 спальни, аристон,стоянка ', 1800, 8, 'HOUSE', 1, 9, 5),
       (10, '2022-08-07', 'Квартира', '2-ком,район горбольницы,', 1800, 4, 'APARTMENT', 1, 10, 5),
       (11, '2022-08-08', 'Квартира', '1-ком,все удобства', 2500, 3, 'APARTMENT', 1, 11, 4),
       (12, '2022-08-08', 'Гост дом Арсланбоб','все удобства,район автовокзала', 1200, 10, 'HOUSE', 1, 12, 4),
       (13, '2022-08-09', 'Гост дом Ат-Башы','все удобства,центр,охрана', 1500, 8, 'HOUSE', 1, 13, 5),
       (14, '2022-08-09', 'Гост дом Саякбай','все удобства,центр,охрана', 1700, 10, 'HOUSE', 1, 14, 5),
       (15, '2022-08-09', 'Гост дом Салкын-Тор','все удобства,центр,охрана', 1800, 9, 'HOUSE', 1, 15, 5),
       (16, '2022-08-10', 'Muhammeds Residense','Все удобства,центр,стоянка,охрана', 1000, 15, 'HOUSE', 1, 16, 4),
       (17, '2022-08-10', 'Babash House','Все удобства,рядом с рынком', 1000, 6, 'HOUSE', 1, 17, 4),
       (18, '2022-08-10', 'Квартира','1-ком,Все удобства,район военкомата', 500, 5, 'APARTMENT', 1, 18, 4),
       (19, '2022-08-11', 'Квартира', '1-ком,все удобства,только иностранцам,', 1500, 3, 'APARTMENT', 1, 19, 5),
       (20, '2022-08-11', 'Квартира', '2-ком,все удобства,семейным только,', 700, 5, 'APARTMENT', 1, 20, 5),
       (21, '2022-08-11', 'Квартира', '3-ком,все удобства,центр', 1200, 6, 'APARTMENT', 1, 21, 5),
       (22, '2022-08-12', 'Гостиница', 'центр,стоянка,охрана,гор.вода', 1350, 22, 'HOUSE', 1, 22, 4),
