...
INSERT INTO announcements(id, created_at, title, description, price, max_guests, house_type, status,
                          location_id, owner_id, likes, bookmarks, view_Announcements, color_Of_Like, color_Of_Bookmark, message_from_admin, rating)
VALUES (1, '2022-08-19', 'Peaksoft', '4 спальни, 5 кроватей, 4 ванные', 2500, 10, 'HOUSE', 1, 1, 4, 23, 12, 348758, null,null, null, 4),
       (2, '2022-04-10', 'Уютная квартира в Тунгуче', '3-комнат, 8-этаж', 1500, 3, 'APARTMENT', 1, 2, 5, 43, 23, 35, null,null, null,  3.8),
       (3, '2022-07-27', 'Элитка в микрашах', '1 спальня, 1 кровать, 1 ванная', 3500, 4, 'APARTMENT', 1, 3, 4, 15, 23, 65, null,null, null , 4),
       (4, '2022-08-04', 'Маяк', '4 спальни, 5 кроватей, 4 ванные', 1700, 8, 'HOUSE', 1, 4, 5, 24, 34, 354, null,null, null  ,4.2),
       (5, '2022-08-05', 'Гостевой дом Парус', '2 спальни, 5 кроватей, 2 ванные', 1700, 5, 'HOUSE', 1, 5, 5, 51, 56, 357, null,null, null,  3.8),
       (6, '2022-08-06', 'Гостиница Алай', '6 спальни, 12 кроватей, 6 ванные', 1700, 18, 'HOUSE', 1, 6, 4, 52, 45, 643, null,null, null , 3.8),
       (7, '2022-08-06', 'Квартира для студентов', '2 спальни, 4 кроватей, газ, центр', 1700, 5, 'APARTMENT', 1, 7, 5, 16, 43, 74, null,null, null,  3.6),
       (8, '2022-08-07', 'Квартира для семьи', '1 спальни, газ, лифт', 800, 4, 'APARTMENT', 1, 8, 4, 26, 43, 564, null,null, null  ,4.6),
       (9, '2022-08-07', 'Гостевой дом Айгул', '3 спальни, аристон,стоянка ', 1800, 8, 'HOUSE', 1, 9, 5, 23, 56, 30, null,null, null , 4.2),
       (10, '2022-08-07', 'Квартира', '2-ком,район горбольницы,', 1800, 4, 'APARTMENT', 1, 10, 5, 12, 76, 340, null,null, null  ,3.6),
       (11, '2022-08-08', 'Квартира', '1-ком,все удобства', 2500, 3, 'APARTMENT', 1, 11, 4, 73, 43, 975, null,null, null , 3.6),
       (12, '2022-08-08', 'Гост дом Арсланбоб','все удобства,район автовокзала', 1200, 10, 'HOUSE', 1, 12, 4, 38, 76, 56, null,null, null  ,3.6),
       (13, '2022-08-09', 'Гост дом Ат-Башы','все удобства,центр,охрана', 1500, 8, 'HOUSE', 1, 13, 5, 53, 54, 665, null,null, null  ,3.6),
       (14, '2022-08-09', 'Гост дом Саякбай','все удобства,центр,охрана', 1700, 10, 'HOUSE', 1, 14, 5, 79, 43, 5463, null,null, null  ,4),
       (15, '2022-08-09', 'Гост дом Салкын-Тор','все удобства,центр,охрана', 1800, 9, 'HOUSE', 1, 15, 5, 17, 67, 768, null,null, null  ,4.2),
       (16, '2022-08-10', 'Muhammeds Residense','Все удобства,центр,стоянка,охрана', 1000, 15, 'HOUSE', 1, 16, 4, 73, 67, 23, null,null, null , 3.6),
       (17, '2022-08-10', 'Babash House','Все удобства,рядом с рынком', 1000, 6, 'HOUSE', 1, 17, 4, 97, 54, 422, null,null, null  ,3.8),
       (18, '2022-08-10', 'Квартира','1-ком,Все удобства,район военкомата', 500, 5, 'APARTMENT', 1, 18, 4, 67, 23, 235, null,null, null  ,4.4),
       (19, '2022-08-11', 'Квартира', '1-ком,все удобства,только иностранцам,', 1500, 3, 'APARTMENT', 1, 19, 5, 34, 27, 2353, null,null, null  ,4.6),
       (20, '2022-08-11', 'Квартира', '2-ком,все удобства,семейным только,', 700, 5, 'APARTMENT', 1, 20, 5, 65, 85, 32523, null,null, null  ,2.6),
       (21, '2022-08-11', 'Квартира', '3-ком,все удобства,центр', 1200, 6, 'APARTMENT', 0, 21, 5, 61, 97, 6755, null,null, null  ,4.6),
       (22, '2022-08-12', 'Гостиница', 'центр,стоянка,охрана,гор.вода', 1350, 22, 'HOUSE', 0, 22, 4, 87, 45, 235, null,null, null  ,4.6),
       (23, '2022-08-12', 'Гостевой Дом Жайыл', 'район вокзала,стоянка,охрана,гор.вода', 1200, 14, 'HOUSE', 0, 23, 4, 54, 24, 23, null,null, null  ,4.4),
       (24, '2022-08-12', 'Гостевой Дом Аксу', 'все удобства', 1200, 12, 'HOUSE', 0, 24, 4, 99, 75, 23523, null,null, null  ,3.8),
       (25, '2022-08-13', 'Квартира', '2-ком,5-мин от пляжа,все удобства', 3000, 6, 'APARTMENT', 0, 25, 5, 34, 93, 2352, null,null, null  ,4.6),
       (26, '2022-08-13', 'Квартира', '1-ком,100 метров до пляжа,все удобства', 2000, 3, 'APARTMENT', 0, 26, 5, 34, 38, 23350, null,null, null  ,2.6),
       (27, '2022-08-13', 'Квартира', '1-ком,центр,студенткам ИГУ,все удобства', 1000, 3, 'APARTMENT', 0, 27, 5, 23, 19, 340, null,null, null  ,3.4);
